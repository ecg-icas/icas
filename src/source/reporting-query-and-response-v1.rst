...
Query
************************************
The metrics query should be provided as a JSON object of type `Metrics Request V1`_, which has these minimum requirements:
...
The response body of the API request is a JSON object of `Metrics Response V1`_ type. Here is a sample response for the sample request above.
