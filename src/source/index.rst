...
* v.0.119 - 24 June 2020 - tw

  * set deprecation date of :ref:`get_ad_v3` to July 15th 2020

* v.0.118 - 10 June 2020 - tw

  * mark :ref:`get_ad_v3` as deprecated, replaced by :ref:`get_ad_v4`
...
* v0.59 - 15 Jun 2015 - fs
  ...
  * Deprecated 'GET /category/{id} V1'
  * Deprecated 'GET /category{id}/attributes V1'
  * Deprecated 'POST /ad V1'
  * Deprecated 'PUT /ad V1'
...
* v0.44 - 24 Feb 2015 - fs
  ...
  * Pushed deadline for removal of 'GET /ad V1' of :ref:`get_ad` from 1 Mar 2015 to 1 May 2015
...
* v0.39 - 20 Nov 2014 - ak
  ...
  * Added 'GET /ad V2' of :ref:`get_ad` which includes the size of the result set
...
* v0.10 - 8 Oct 2012 - fs, ml
  ...
  * 'GET /category/{id}/attributes': only leaf categories have attributes
...
* v0.8 - 4 Oct 2012 - fs
  ...
  * Added 'GET /category/{id}/attributes'
