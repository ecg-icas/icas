...
``am:avgBidMicros``                Double     Hit        Average Cost Per Click. Calculation
``am:avgBilledMicros``             Double     Hit        Average Cost Per Click Billed. Calculation
...
``am:currentAdBidMicros``     Long         Current bid micros of the ad
