...
``am:eCPC``                        Double     Hit        Total spent on the ad divided by the number of website clicks
``am:sessionECPC``                 Long       Session    Total spent on the ad divided by the number of unique sessions with website clicks
