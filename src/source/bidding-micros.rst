.. note::
    We introduced a new monetary unit of micros across our product more recently, where **one cent equals 10000 micros**. **One micro is 1-millionth of the local tenant currency**. This will allow for a higher level of granularity when specifying the cost (per click).
