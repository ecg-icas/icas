...
The ad has been paused by Customer Service and can be re-activated by the user. The seller should have received an email with an explanation for this status change.
